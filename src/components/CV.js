  ...
  return (
    <>
      ...
      <div className="row page-title">
        <h4><i className="fa fa-graduation-cap cv-icon" />Education</h4>
      </div>
      <div className="page-content">
        <Education />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-laptop cv-icon" />Professional Interest</h4>
      </div>
      <div className="page-content">
        <ProfessionalInterests />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-terminal cv-icon" />Computer Skills</h4>
      </div>
      <div className="page-content">
        <ComputerSkills />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-user cv-icon" />Positions Of Responsibility</h4>
      </div>
      <div className="page-content">
        <POR />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-briefcase cv-icon" />Internship Experience</h4>
      </div>
      <div className="page-content">
        <Internships />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-cogs cv-icon" />Hackathon</h4>
      </div>
      <div className="page-content">
        <Hackathon />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-bookmark cv-icon" />Volunteer Experience</h4>
      </div>
      <div className="page-content">
        <VE />
      </div>
      <div className="row page-title">
        <h4><i className="fa fa-cubes cv-icon" />Hobbies/Interests</h4>
      </div>
      <div className="page-content">
        <Hobbies />
      </div>
