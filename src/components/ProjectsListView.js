    ...
    <>
      ...
      <div id="page-content">
        ...
        <ul className="list-unstyled row mt-5">
          {
            projects 
            ? projects.map(project =><li key={project.id} className="col-md-6" style={{ margin: "0", padding: "0" }}><div className="project"><Link className="text-white" to={"/projects/" + project.id}><h5>{project.title}</h5></Link><p className="mt-2 mb-2">{project['s-desc']}</p></div></li>) 
